                    ...
                    char savename[])
{
    ...
    {
        case 0:
            strcpy(temp,"Clumping - default step function");
            break;
        case 1:
            strcpy(temp,"Clumping - two level step function.");
            break;
        case 2:
            strcpy(temp,"Clumping - rising benefit function");
            break;
    }
    fprintf(fp,"%s\n",temp);
    ...
    {
        case 0:
            strcpy(temp,"Annealing and Heuristic");
            break;
        case 1:
            strcpy(temp,"Annealing and Iterative Improvement");
            break;
        case 2:
            strcpy(temp,"Annealing and Both");
            break;
        case 3:
            strcpy(temp,"Heuristic only");
            break;
        case 4:
            strcpy(temp,"Iterative Improvement only");
            break;
        case 5:
            strcpy(temp,"Heuristic and Iterative Improvement");
    }
    ...
    if (runopts == 0 || runopts == 3 || runopts == 5)
    {
        ...
        {
            case 0:
                strcpy(temp,"Richness");
                break;
            case 1:
                strcpy(temp,"Greedy");
                break;
            case 2:
                strcpy(temp,"Maximum Rarity");
                break;
            case 3:
                strcpy(temp,"Best Rarity");
                break;
            case 4:
                strcpy(temp,"Average Rarity");
                break;
            case 5:
                strcpy(temp,"Summation Rarity");
                break;
            case 6:
                strcpy(temp,"Product Irreplaceability");
                break;
            case 7:
                strcpy(temp,"Summation Irreplaceability");
                break;
            default:
                strcpy(temp,"Unkown Heuristic Type");
        }

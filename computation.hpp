...
namespace marxan {
    ...
    inline double connectionCost1(const sconnections& connections, double cm, int asymmetricconnectivity)
    {
        double fcost;
    ...
    inline int computeRepresentationMISSLEVEL(int spno, const vector<sspecies>& spec, double misslevel, double& shortfall, double& rMinimumProportionMet)
    {
        int i, isp = 0;
    ...
    inline void computeConnectivityIndices(double& rConnectivityTotal, double& rConnectivityIn,
    ...
    inline void computeOccurrencesAndAreas(int& puno, const vector<spustuff>& pu, const vector<spu>& SM,
    ...
    inline void computeExpectedAndVariance(int ipu, const vector<spustuff>& pu, const vector<spu>& SM, vector<double>& variance, vector<double>& expected) {
        int i, ism, isp;
    ...
    inline pair<int, double> returnAmountSpecAtPu(const spustuff& pu, const vector<spu>& SM, int iSpecIndex)
    {
        if (pu.richness > 0)
        {
    ...
    inline double computeTotalSpecAmtAllPu(const vector<spustuff>& PU, const vector<spu>& SM, int speciesInd)
    {
    ...
    inline void computeSpecProp(int spno, vector<sspecies>& spec, int puno, const vector<spustuff>& pu, const vector<spu>& SM)
    {
    ...
    inline void computeFixedPenaltyForSpec(const vector<int>& R, const vector<spustuff>& pu, const vector<spu>& SM, const vector<sconnections>& connections, int spIndex,
    ...
    inline double ConnectionCost2(const sconnections& connection, const vector<int>& R, int imode, int imode2, double cm,

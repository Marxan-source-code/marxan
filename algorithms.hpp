...
namespace marxan {
    namespace algorithms {
        ...
        inline void initialiseReserve(double prop, const vector<spustuff>& pu, vector<int>& R, mt19937& rngEngine)
        {
        ...
        inline void applyUserPenalties(vector<sspecies>& spec)
        {
        ...
        inline void populateLookupTables(int puno, int spno, vector<spustuff>& pu, vector<sspecies>& spec,
        ...
        inline void setDefaultTargets(vector<sspecies>& spec)
        {
